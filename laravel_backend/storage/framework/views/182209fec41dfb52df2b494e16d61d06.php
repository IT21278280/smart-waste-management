<?php $__env->startSection('title', 'Analytics - Smart Waste Management'); ?>
<?php $__env->startSection('page-title', 'Analytics & Insights'); ?>
<?php $__env->startSection('page-description', 'Comprehensive analytics and insights from AI-powered waste management data'); ?>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body text-center p-4" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 0.5rem;">
                ...
                <h3 class="fw-bold mb-1"><?php echo e($totalReports); ?></h3>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body text-center p-4" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); color: white; border-radius: 0.5rem;">
                ...
                <h3 class="fw-bold mb-1"><?php echo e($processedReports); ?></h3>
                <p class="mb-0 opacity-75">Processed</p>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body text-center p-4" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white; border-radius: 0.5rem;">
                ...
                <h3 class="fw-bold mb-1"><?php echo e($pendingReports); ?></h3>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body text-center p-4" style="background: linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%); color: #333; border-radius: 0.5rem;">
                ...
                <h3 class="fw-bold mb-1"><?php echo e($processingReports); ?></h3>
            ...
            <div class="card-body">
                ...
                <div class="text-center mt-3">
                    <small class="text-muted">
                        ...
                        Reports submitted in <?php echo e(date('Y')); ?>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="category-card p-3 rounded-3 h-100" style="background: linear-gradient(135deg, #d4edda 0%, #c3e6cb 100%); border-left: 4px solid #28a745;">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="badge bg-success px-3 py-2 rounded-pill"><?php echo e(number_format((($wasteTypes->where('waste_type', 'organic')->first()->count ?? 0) / max($totalReports, 1)) * 100, 1)); ?>%</span>
                            </div>
                            <h3 class="fw-bold text-success mb-1"><?php echo e($wasteTypes->where('waste_type', 'organic')->first()->count ?? 0); ?></h3>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="category-card p-3 rounded-3 h-100" style="background: linear-gradient(135deg, #cce7ff 0%, #b3d9ff 100%); border-left: 4px solid #007bff;">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="badge bg-primary px-3 py-2 rounded-pill"><?php echo e(number_format((($wasteTypes->where('waste_type', 'plastic')->first()->count ?? 0) / max($totalReports, 1)) * 100, 1)); ?>%</span>
                            </div>
                            <h3 class="fw-bold text-primary mb-1"><?php echo e($wasteTypes->where('waste_type', 'plastic')->first()->count ?? 0); ?></h3>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="category-card p-3 rounded-3 h-100" style="background: linear-gradient(135deg, #d1ecf1 0%, #bee5eb 100%); border-left: 4px solid #17a2b8;">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="badge bg-info px-3 py-2 rounded-pill"><?php echo e(number_format((($wasteTypes->where('waste_type', 'glass')->first()->count ?? 0) / max($totalReports, 1)) * 100, 1)); ?>%</span>
                            </div>
                            <h3 class="fw-bold text-info mb-1"><?php echo e($wasteTypes->where('waste_type', 'glass')->first()->count ?? 0); ?></h3>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="category-card p-3 rounded-3 h-100" style="background: linear-gradient(135deg, #e2e3e5 0%, #d6d8db 100%); border-left: 4px solid #6c757d;">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="badge bg-secondary px-3 py-2 rounded-pill"><?php echo e(number_format((($wasteTypes->where('waste_type', 'metal')->first()->count ?? 0) / max($totalReports, 1)) * 100, 1)); ?>%</span>
                            </div>
                            <h3 class="fw-bold text-secondary mb-1"><?php echo e($wasteTypes->where('waste_type', 'metal')->first()->count ?? 0); ?></h3>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="category-card p-3 rounded-3 h-100" style="background: linear-gradient(135deg, #f8d7da 0%, #f5c6cb 100%); border-left: 4px solid #dc3545;">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="badge bg-danger px-3 py-2 rounded-pill"><?php echo e(number_format((($wasteTypes->where('waste_type', 'hazardous')->first()->count ?? 0) / max($totalReports, 1)) * 100, 1)); ?>%</span>
                            </div>
                            <h3 class="fw-bold text-danger mb-1"><?php echo e($wasteTypes->where('waste_type', 'hazardous')->first()->count ?? 0); ?></h3>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="category-card p-3 rounded-3 h-100" style="background: linear-gradient(135deg, #fff3cd 0%, #ffeaa7 100%); border-left: 4px solid #ffc107;">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="badge bg-warning text-dark px-3 py-2 rounded-pill"><?php echo e(number_format((($wasteTypes->where('waste_type', null)->first()->count ?? 0) / max($totalReports, 1)) * 100, 1)); ?>%</span>
                            </div>
                            <h3 class="fw-bold text-warning mb-1"><?php echo e($wasteTypes->where('waste_type', null)->first()->count ?? 0); ?></h3>
            ...
            <div class="card-body p-4">
                ...
                <div class="text-center">
                    <div class="d-flex justify-content-around mb-3">
                        <div class="text-center">
                            <div class="fw-bold text-primary fs-5"><?php echo e($totalReports); ?></div>
                            <small class="text-muted">Total Processed</small>
                        </div>
                        <div class="text-center">
                            <div class="fw-bold text-success fs-5"><?php echo e(number_format($totalReports > 0 ? ($processedReports / $totalReports) * 100 : 0, 1)); ?>%</div>
                            <small class="text-muted">Success Rate</small>
                        </div>
                    </div>
                    <small class="text-muted">Last updated: <?php echo e(now()->format('M d, Y H:i')); ?></small>
                </div>
            </div>
        </div>
    </div>
...
const wasteTypeChart = new Chart(wasteTypeCtx, {
    ...
    data: {
        ...
        datasets: [{
            data: [
                <?php echo e($wasteTypes->where('waste_type', 'organic')->first()->count ?? 0); ?>,
                <?php echo e($wasteTypes->where('waste_type', 'plastic')->first()->count ?? 0); ?>,
                <?php echo e($wasteTypes->where('waste_type', 'glass')->first()->count ?? 0); ?>,
                <?php echo e($wasteTypes->where('waste_type', 'metal')->first()->count ?? 0); ?>,
                <?php echo e($wasteTypes->where('waste_type', 'hazardous')->first()->count ?? 0); ?>,
                <?php echo e($wasteTypes->where('waste_type', null)->first()->count ?? 0); ?>
        ...
        datasets: [{
            ...
            data: [
                <?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo e($monthlyReports->where('month', $month)->first()->count ?? 0); ?>,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\Smart Waste App\laravel_backend\resources\views/analytics.blade.php ENDPATH**/ ?>