...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Smart Waste Management'); ?></title>
            ...
            <div class="col-md-3 col-lg-2 px-0">
                <div class="sidebar p-3">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('api-test')); ?>">
                                <i class="fas fa-code me-2"></i>API Test
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('ml-test')); ?>">
                        ...
                        <a class="nav-link <?php echo e(request()->is('analytics*') ? 'active' : ''); ?>" href="/analytics">
                            <i class="fas fa-chart-bar me-2"></i> Analytics
                        </a>
                        <a class="nav-link <?php echo e(request()->is('test*') ? 'active' : ''); ?>" href="/test">
                ...
                <div class="main-content p-4">
                    <div class="content-wrapper">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-5" data-aos="fade-down">
                            <div>
                                <h2 class="fw-bold flat-text mb-1"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h2>
                                <p class="text-muted mb-0"><?php echo $__env->yieldContent('page-description', 'Welcome to Smart Waste Management System'); ?></p>
                            </div>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="text-end">
                                    <div class="fw-semibold"><?php echo e(now()->format('M d, Y')); ?></div>
                                    <small class="text-muted"><?php echo e(now()->format('H:i A')); ?></small>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\Users\USER\Desktop\Smart Waste App\laravel_backend\resources\views/layouts/app.blade.php ENDPATH**/ ?>